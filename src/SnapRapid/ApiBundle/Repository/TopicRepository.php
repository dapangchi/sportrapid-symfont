...
use SnapRapid\Core\Repository\TopicRepositoryInterface;

class TopicRepository extends ReadOnlyDocumentRepository implements TopicRepositoryInterface
{
    ...
    {
        return 'SnapRapidApiBundle:Topic';
    }
}
