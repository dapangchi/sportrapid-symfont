...
use SnapRapid\Core\Repository\LabelRepositoryInterface;

class LabelRepository extends ReadOnlyDocumentRepository implements LabelRepositoryInterface
{
    ...
    {
        return 'SnapRapidApiBundle:Label';
    }
}
